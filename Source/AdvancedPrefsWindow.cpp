...
AdvancedPrefsWindow::AdvancedPrefsWindow()
	: BWindow (BRect (0, 0, 440, 270-60), "Advanced Preferences", B_TITLED_WINDOW, B_NOT_ZOOMABLE | B_NOT_RESIZABLE | B_AUTO_UPDATE_SIZE_LIMITS,
				B_CURRENT_WORKSPACE),
		fPreviousSelection(0)
{
	PRINT (("AdvancedPrefsWindow::AdvancedPrefsWindow ()\n"));
	...
	RenderFunc reportFuncPtr = &AdvancedPrefsWindow::MakeViewReport;
	RenderFunc itemsFuncPtr = &AdvancedPrefsWindow::MakeViewItems;
	RenderFunc loopersFuncPtr = &AdvancedPrefsWindow::MakeViewLoopers;
	RenderFunc rememberFuncPtr = &AdvancedPrefsWindow::MakeViewRemember;
	RenderFunc pluginsFuncPtr = &AdvancedPrefsWindow::MakeViewPlugins;
	RenderFunc miscFuncPtr = &AdvancedPrefsWindow::MakeViewMiscellaneous;
	...
	*reportSavePtr = &AdvancedPrefsWindow::SaveViewReport;
	*itemsSavePtr = &AdvancedPrefsWindow::SaveViewItems;
	*loopersSavePtr = &AdvancedPrefsWindow::SaveViewLoopers;
	*rememberSavePtr = &AdvancedPrefsWindow::SaveViewRemember;
	*pluginsSavePtr = &AdvancedPrefsWindow::SaveViewPlugins;
	*miscSavePtr = &AdvancedPrefsWindow::SaveViewMiscellaneous;
	...
	SLFunc reportLoadPtr = &AdvancedPrefsWindow::LoadViewReport;
	SLFunc itemsLoadPtr = &AdvancedPrefsWindow::LoadViewItems;
	SLFunc loopersLoadPtr = &AdvancedPrefsWindow::LoadViewLoopers;
	SLFunc rememberLoadPtr = &AdvancedPrefsWindow::LoadViewRemember;
	SLFunc pluginsLoadPtr = &AdvancedPrefsWindow::LoadViewPlugins;
	SLFunc miscLoadPtr = &AdvancedPrefsWindow::LoadViewMiscellaneous;
...
void AdvancedPrefsWindow::Quit ()
{
	be_app_messenger.SendMessage (M_CLOSE_ADVANCED_PREFS);
	BWindow::Quit();
}

/*============================================================================================================*/

void AdvancedPrefsWindow::MessageReceived (BMessage *message)
{
	switch (message->what)
	{
...
PrefsView* AdvancedPrefsWindow::ConstructPrefsView (const char *desc, RenderFunc func, SLFunc slfunc)
{
...
void AdvancedPrefsWindow::MakeViewReport (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewReport (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewReport ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewReport ()\n"));
...
void AdvancedPrefsWindow::LoadViewReport ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewReport ()\n"));
...
void AdvancedPrefsWindow::MakeViewItems (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewItems (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewItems ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewItems ()\n"));
...
void AdvancedPrefsWindow::LoadViewItems ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewItems ()\n"));
...
void AdvancedPrefsWindow::MakeViewLoopers (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewLoopers (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewLoopers ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewLoopers ()\n"));
...
void AdvancedPrefsWindow::LoadViewLoopers ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewLoopers ()\n"));
...
void AdvancedPrefsWindow::MakeViewRemember (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewRemember (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewRemember ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewRemember ()\n"));
...
void AdvancedPrefsWindow::LoadViewRemember ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewRemember ()\n"));
...
void AdvancedPrefsWindow::MakeViewPlugins (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewPlugins (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewPlugins ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewPlugins ()\n"));
...
void AdvancedPrefsWindow::LoadViewPlugins ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewPlugins ()\n"));
...
void AdvancedPrefsWindow::MakeViewMiscellaneous (BView *vw)
{
	PRINT (("AdvancedPrefsWindow::MakeViewMiscellaneous (BView*)\n"));
...
void AdvancedPrefsWindow::SaveViewMiscellaneous ()
{
	PRINT (("AdvancedPrefsWindow::SaveViewMiscellaneous ()\n"));
...
void AdvancedPrefsWindow::LoadViewMiscellaneous ()
{
	PRINT (("AdvancedPrefsWindow::LoadViewMiscellanous ()\n"));
...
void AdvancedPrefsWindow::AddOptionsToListView(BListView* listView, BStringItem* item)
{
...
bool AdvancedPrefsWindow::IsChecked (BCheckBox *chkBox) const
{
...
int32 AdvancedPrefsWindow::CheckBoxValue (bool value) const
{
